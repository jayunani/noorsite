...
class ShaadiDetails extends React.Component {
  render() {
    let event = {
      ...
      endTime: '2017-07-05T00:00:00-07:00'
    }
    return (
        ...
        <div className='mendhi-content'>
          ...
          <div className='rsvp-form'>
            ...
            <div className='event-form'>
              <iframe id='collapsed-form-mendhi' className='collapse collapsed-div'  src="https://docs.google.com/forms/d/e/1FAIpQLSdkJilckA5Ldg9jzMLWwntquGT17lR9KnnLglCkKO6IEC2aBA/viewform?embedded=true" width="450" height="400" frameborder="0" marginheight="0" marginwidth="0" sandbox="allow-forms">Loading...</iframe>
            </div>
          </div>
        </div>
      </div>
