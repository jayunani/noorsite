        ...
        <div className='mendhi-content'>
          ...
          <div className='rsvp-form'>
            ...
            <div className='event-form'>
              <iframe id='collapsed-form-mendhi' className='collapse collapsed-div'  src="https://docs.google.com/forms/d/e/1FAIpQLScjffUYeNEWlK9JijhzoS7i3orOCBf7P3cQgcgAukZoQlgSZg/viewform?embedded=true" width="450" height="400" frameborder="0" marginheight="0" marginwidth="0" sandbox="allow-forms">Loading...</iframe>
            </div>
          </div>
